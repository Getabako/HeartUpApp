...
const sampleResources = [
    ...
    },
    {
        ...
        title: "カウンセリング",
        category: "psychology",
        description: "カウンセリングの基本的な考え方と技法を学びます。子どもや保護者との関わりに活かせる傾聴・共感のスキルを解説。",
        date: "2026-01-23",
        tags: ["カウンセリング", "傾聴", "共感", "支援スキル"],
        filename: "カウンセリング.pdf",
        hasFile: true
    },
    {
        id: 8,
        title: "ラポール形成",
        category: "psychology",
        description: "子どもとの信頼関係（ラポール）を築くための心理学的アプローチを学びます。ロジャーズの3条件、身体的ペーシング、失敗・癇癪時の声かけ、送迎時の3分間トークなど、サッカー療育の現場ですぐ使える実践方法を解説。",
        date: "2026-04-27",
        tags: ["ラポール形成", "信頼関係", "声かけ", "保護者対応"],
        filename: "ラポール形成.pdf",
        hasFile: true
    },
    {
        id: 9,
        title: "子どもを支える人のためのセルフケア入門",
        category: "psychology",
        description: "支援者自身のメンタルヘルスを守るためのセルフケアを学びます。ストレスの仕組みを理解し、燃え尽きを防いで長く子どもと向き合うための実践的な方法を紹介。",
        date: "2026-05-21",
        tags: ["セルフケア", "メンタルヘルス", "ストレス対処", "支援者支援"],
        filename: "子どもを支える人のためのセルフケア入門.pdf",
        hasFile: true
    },
    {
        id: 10,
        title: "サッカー療育で\"その子の可能性\"を伸ばす勉強会",
        category: "soccer",
        description: "実行機能（ワーキングメモリ・抑制・切り替え）の視点から子どもの特性や困り感を見立て、支援につなげる方法を学びます。\"まわりが困る子\"ではなく\"本人が困っている子\"という捉え方、特性に合わせた指示量や問いかけの工夫を、集団・サッカー場面のケースで解説。",
        date: "2026-07-06",
        tags: ["実行機能", "見立て", "ワーキングメモリ", "特性理解", "サッカー療育"],
        filename: "サッカー療育で可能性を伸ばす.pdf",
        hasFile: true
    }
];
